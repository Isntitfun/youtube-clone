...
exports.postUpload = exports.postEditVideo = exports.getVideo = exports.getUpload = exports.getSearch = exports.getHome = exports.getEditVideo = exports.getDeleteVideo = void 0;
...
var getHome = /*#__PURE__*/function () {
  ...
  return function getHome(_x, _x2, _x3) {
...
var getSearch = /*#__PURE__*/function () {
  ...
  return function getSearch(_x4, _x5, _x6) {
...
var getVideo = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            id = req.params.id;
            _context3.next = 3;
            return _videos["default"].findById(id).populate([{
              path: "owner"
            }, {
              path: "comments",
              populate: {
  ...
  return function getVideo(_x7, _x8, _x9) {
...
var getEditVideo = /*#__PURE__*/function () {
  ...
  return function getEditVideo(_x10, _x11, _x12) {
...
var postEditVideo = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res, next) {
    var id, video, _req$body, title, description, hashtags, editedVideo;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 10:
            editedVideo = _context5.sent;
            req.flash("info", "Successfuly edited");
            res.redirect("/video/".concat(id));
          case 13:
          case "end":
  ...
  return function postEditVideo(_x13, _x14, _x15) {
    return _ref5.apply(this, arguments);
  };
}();
exports.postEditVideo = postEditVideo;
var getDeleteVideo = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 7:
            ...
            _context6.next = 10;
            return _videos["default"].findByIdAndDelete(id);
          case 10:
  ...
  return function getDeleteVideo(_x16, _x17, _x18) {
    return _ref6.apply(this, arguments);
  };
}();
exports.getDeleteVideo = getDeleteVideo;
var getUpload = function getUpload(req, res, next) {
...
var postUpload = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res, next) {
    var _id, _req$body2, title, description, hashtags, files, video, thumbnail, newVideo, user;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _id = req.session.user._id, _req$body2 = req.body, title = _req$body2.title, description = _req$body2.description, hashtags = _req$body2.hashtags, files = req.files;
            video = files.video[0];
  ...
  return function postUpload(_x19, _x20, _x21) {
